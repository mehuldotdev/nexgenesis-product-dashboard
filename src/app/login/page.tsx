          ...
          <div>
            ...
            <div className="relative mt-1">
              ...
              <input
                ...
                placeholder="emilys"
                className="w-full rounded-lg border border-zinc-300 bg-white py-2.5 pl-9 pr-3 text-xs text-zinc-900 placeholder:text-zinc-400 focus:border-zinc-900 focus:outline-none focus:ring-1 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100 dark:placeholder:text-zinc-500 dark:focus:border-zinc-300 dark:focus:ring-zinc-300"
              />
            </div>
          </div>
